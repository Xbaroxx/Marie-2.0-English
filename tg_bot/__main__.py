...
PM_START_TEXT = """
 ───「[ZoroXRobot](https://telegra.ph/file/14732a0dc9dbbaf922dad.jpg)」───
*Hola! I am *Zoro*
Zoro a powerful group management bot built to help you manage your group!
...
buttons = [
        ...
        InlineKeyboardButton(
            text="➕️ Add Zoro to tour group ➕️", url="t.me/ZoroXRobot?startgroup=true"
        ),
    ],
    [
        ...
        InlineKeyboardButton(
            text="Assistant", url="t.me/Asisstance"
        ),
    ],
    [
...
It took lots of work for [my creator](t.me/ZoroXSupport) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
There are two ways of paying him; [PayPal](paypal.me/PaulSonOfLars), or [Xbrox](t.me/Xbarok)."""
    ...
    if update.effective_chat.type == "private":
        ...
        reply_markup=InlineKeyboardMarkup(
                [
                  ...
                  InlineKeyboardButton(text=" Updates ", url=f"t.me/ZoroUpdates"),
                  ]
                ]
            ),
        )
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(VegetaRobot_about_callback, pattern=r"aboutmanu_")
